    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_down:
                ...
                editText2.setText(functions.otherConverter(functions.Energy, id1, value, id2).toString());
                break;
            case R.id.btn_up:
                value = functions.convertToDouble(editText2.getText().toString());
                editText1.setText(functions.otherConverter(functions.Energy, id2, value, id1).toString());
                break;
            default:
                break;
        }
