...
public class activity_temperature extends AppCompatActivity implements TextWatcher, AdapterView.OnItemSelectedListener {
    ...
    void loadSpinner() {
        listTemperature = new ArrayList<>(Arrays.asList(functions.Temperature));
