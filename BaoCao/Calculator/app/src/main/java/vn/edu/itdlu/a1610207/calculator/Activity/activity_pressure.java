    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_down:
                ...
                editText2.setText("" + functions.otherConverter(functions.Pressure, id1, value, id2));
                break;
            case R.id.btn_up:
                value = functions.convertFromString(editText2.getText().toString());
                editText1.setText("" + functions.otherConverter(functions.Pressure, id2, value, id1));
                break;
            default:
                break;
        }
