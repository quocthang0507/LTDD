...
public class activity_time extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i(getApplicationContext().getResources().getString(R.string.tag), "Opening activity_time...");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_down:
                ...
                editText2.setText(functions.otherConverter(functions.Time, id1, value, id2).toString());
                break;
            case R.id.btn_up:
                value = functions.convertToDouble(editText2.getText().toString());
                editText1.setText(functions.otherConverter(functions.Time, id2, value, id1).toString());
                break;
            default:
                break;
        }
